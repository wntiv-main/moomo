...
import { enumerate, ItemOf } from "./util";

export function latexToStack(latex: string, matrixFormat: 'function' | 'grid' = 'function') {
...
if (DEBUG) {
	for (const key of Object.getOwnPropertyNames(LatexParser.prototype)) {
