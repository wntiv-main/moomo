...
import { asyncTimeout, LazyPromise } from "../util";

const toast = LazyPromise.wrap(() => import('core/toast'));

const DEBUG_SCRIPTING = true; // TODO
...
export async function loadScripts(
	...
	for (const script of scripts) {
		...
		if (script.hasAttribute('async')) asyncScripts.push(loadingScript);
